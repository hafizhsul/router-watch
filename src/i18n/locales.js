...
const en = {
  ...
  "nav.label": "Primary",
  "nav.board": "Board",
  "nav.matrix": "Comparison Matrix",
  "nav.status": "API Status",
  "matrix.eyebrow": "Comparison Matrix",
  "matrix.title": "Side-by-side gateway comparison",
  "matrix.body": "A full comparison table is not published yet. The board already lists every gateway with its bonus, models, and audit status.",
  "matrix.cta": "Back to the board",
  "status.eyebrow": "API Status",
  "status.title": "Gateway status feed",
  "status.body": "Live uptime monitoring is not wired up yet. Verification badges on the board reflect the last manual audit.",
  "status.cta": "Back to the board",
...
export const LOCALES = {
  ...
  "nav.label": "Navigasi",
  "nav.board": "Papan",
  "nav.matrix": "Matriks Perbandingan",
  "nav.status": "Status API",
  "matrix.eyebrow": "Matriks Perbandingan",
  "matrix.title": "Perbandingan gateway berdampingan",
  "matrix.body": "Tabel perbandingan lengkap belum diterbitkan. Papan sudah mencantumkan setiap gateway dengan bonus, model, dan status auditnya.",
  "matrix.cta": "Kembali ke papan",
  "status.eyebrow": "Status API",
  "status.title": "Umpan status gateway",
  "status.body": "Pemantauan uptime langsung belum tersambung. Lencana verifikasi di papan mencerminkan audit manual terakhir.",
  "status.cta": "Kembali ke papan",
  ...
  "nav.matrix": "比較マトリックス",
  "nav.status": "APIステータス",
  "matrix.eyebrow": "比較マトリックス",
  "matrix.title": "ゲートウェイの横並び比較",
  "matrix.body": "詳細な比較表はまだ公開されていません。ボードには各ゲートウェイのボーナス、モデル、監査ステータスが掲載されています。",
  "matrix.cta": "ボードに戻る",
  "status.eyebrow": "APIステータス",
  "status.title": "ゲートウェイのステータス",
  "status.body": "稼働率のリアルタイム監視はまだ接続されていません。ボードの確認バッジは最新の手動監査を反映しています。",
  "status.cta": "ボードに戻る",
  ...
  "matrix.eyebrow": "对比矩阵",
  "matrix.title": "网关横向对比",
  "matrix.body": "完整对比表尚未发布。看板已列出每个网关的奖励、模型和审计状态。",
  "matrix.cta": "返回看板",
  "status.eyebrow": "API 状态",
  "status.title": "网关状态动态",
  "status.body": "实时可用性监控尚未接入。看板上的验证徽章反映最近一次手动审计结果。",
  "status.cta": "返回看板",
  ...
  "nav.board": "Tablero",
  "nav.matrix": "Matriz comparativa",
  "nav.status": "Estado de la API",
  "matrix.eyebrow": "Matriz comparativa",
  "matrix.title": "Comparación de gateways lado a lado",
  "matrix.body": "Aún no se publica una tabla comparativa completa. El tablero ya muestra cada gateway con su bono, modelos y estado de auditoría.",
  "matrix.cta": "Volver al tablero",
  "status.eyebrow": "Estado de la API",
  "status.title": "Estado de los gateways",
  "status.body": "La monitorización de disponibilidad en vivo aún no está conectada. Las insignias de verificación reflejan la última auditoría manual.",
  "status.cta": "Volver al tablero",
  ...
  "nav.board": "Painel",
  "nav.matrix": "Matriz comparativa",
  "nav.status": "Status da API",
  "matrix.eyebrow": "Matriz comparativa",
  "matrix.title": "Comparação de gateways lado a lado",
  "matrix.body": "A tabela comparativa completa ainda não foi publicada. O painel já lista cada gateway com seu bônus, modelos e status de auditoria.",
  "matrix.cta": "Voltar ao painel",
  "status.eyebrow": "Status da API",
  "status.title": "Status dos gateways",
  "status.body": "O monitoramento de disponibilidade em tempo real ainda não está conectado. Os selos de verificação refletem a última auditoria manual.",
  "status.cta": "Voltar ao painel",
  ...
  "nav.board": "Tableau",
  "nav.matrix": "Matrice comparative",
  "nav.status": "État de l'API",
  "matrix.eyebrow": "Matrice comparative",
  "matrix.title": "Comparaison des passerelles côte à côte",
  "matrix.body": "Le tableau comparatif complet n'est pas encore publié. Le tableau affiche déjà chaque passerelle avec son bonus, ses modèles et son statut d'audit.",
  "matrix.cta": "Retour au tableau",
  "status.eyebrow": "État de l'API",
  "status.title": "État des passerelles",
  "status.body": "La surveillance de disponibilité en temps réel n'est pas encore connectée. Les badges de vérification reflètent le dernier audit manuel.",
  "status.cta": "Retour au tableau",
