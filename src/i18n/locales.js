...
const en = {
  ...
  "hero.cta.criteria": "Our Audit Criteria",
  ...
  "table.rating": "Rating",
  "table.action": "Action",
  "methodology.title": "How does Router Watch classify “Verified”?",
  "methodology.body": "We programmatically create clean GitHub environments and verify that the promised credits actually route to authentic first-party LLM weights without synthetic token manipulation or unexpected credit expiration within 7 days.",
  "methodology.cta": "Read Full Methodology",
  "footer.nav": "Footer",
  "footer.methodology": "Methodology",
  "footer.submit": "Submit Router",
  "footer.standards": "Audit Standards",
...
export const LOCALES = {
  ...
  id: {
    ...
    "hero.cta.criteria": "Kriteria Audit Kami",
    ...
    "table.rating": "Rating",
    "table.action": "Aksi",
    "methodology.title": "Bagaimana Router Watch mengklasifikasikan “Terverifikasi”?",
    "methodology.body": "Kami membuat lingkungan GitHub bersih secara terprogram dan memverifikasi bahwa kredit yang dijanjikan benar-benar mengarah ke bobot LLM pihak pertama yang asli tanpa manipulasi token sintetis atau kedaluwarsa tak terduga dalam 7 hari.",
    "methodology.cta": "Baca Metodologi Lengkap",
    "footer.nav": "Footer",
    "footer.methodology": "Metodologi",
    "footer.submit": "Kirim Router",
    "footer.standards": "Standar Audit",
  ...
  ja: {
    ...
    "table.rating": "評価",
    "table.action": "操作",
    "methodology.title": "Router Watchは「確認済み」をどう分類しますか？",
    "methodology.body": "クリーンなGitHub環境をプログラムで作成し、約束されたクレジットが合成トークン操作や7日以内の予期せぬ失効なく正規の一次LLMウェイトに到達することを検証します。",
    "methodology.cta": "詳細な手法を読む",
    "footer.nav": "フッター",
    "footer.methodology": "手法",
    "footer.submit": "ルーターを投稿",
    "footer.standards": "監査基準",
    "footer.report": "係争を報告",
  ...
  zh: {
    ...
    "table.rating": "评分",
    "table.action": "操作",
    "methodology.title": "Router Watch 如何判定“已核实”？",
    "methodology.body": "我们以编程方式创建干净的 GitHub 环境，验证承诺的额度确实路由到真实的第一方 LLM 权重，不存在合成 token 操纵，也不会在 7 天内意外过期。",
    "methodology.cta": "阅读完整方法",
    "footer.nav": "页脚",
    "footer.methodology": "方法",
    "footer.submit": "提交网关",
    "footer.standards": "审计标准",
    "footer.report": "报告争议",
  ...
  es: {
    ...
    "hero.cta.criteria": "Nuestros criterios de auditoría",
    ...
    "table.action": "Acción",
    "methodology.title": "¿Cómo clasifica Router Watch un «Verificado»?",
    "methodology.body": "Creamos entornos GitHub limpios por programa y verificamos que los créditos prometidos lleguen a pesos LLM auténticos de primera parte, sin manipulación sintética ni caducidad inesperada en 7 días.",
    "methodology.cta": "Leer la metodología completa",
    "footer.nav": "Pie",
    "footer.methodology": "Metodología",
    "footer.submit": "Enviar router",
    "footer.standards": "Estándares de auditoría",
  ...
  pt: {
    ...
    "hero.cta.count": "Ver {n} gateways verificados",
    "hero.cta.criteria": "Nossos critérios de auditoria",
    ...
    "table.action": "Ação",
    "methodology.title": "Como o Router Watch classifica um «Verificado»?",
    "methodology.body": "Criamos ambientes GitHub limpos por programa e verificamos se os créditos prometidos chegam a pesos LLM autênticos de primeira parte, sem manipulação sintética nem expiração inesperada em 7 dias.",
    "methodology.cta": "Ler a metodologia completa",
    "footer.nav": "Rodapé",
    "footer.methodology": "Metodologia",
    "footer.submit": "Enviar router",
    "footer.standards": "Padrões de auditoria",
    "footer.report": "Informar disputa",
  ...
  fr: {
    ...
    "hero.cta.criteria": "Nos critères d’audit",
    ...
    "table.rating": "Note",
    "table.action": "Action",
    "methodology.title": "Comment Router Watch classe un « Vérifié » ?",
    "methodology.body": "Nous créons des environnements GitHub propres par programme et vérifions que les crédits promis atteignent bien des poids LLM authentiques de première partie, sans manipulation synthétique ni expiration inattendue sous 7 jours.",
    "methodology.cta": "Lire la méthodologie complète",
    "footer.nav": "Pied de page",
    "footer.methodology": "Méthodologie",
    "footer.submit": "Proposer une passerelle",
    "footer.standards": "Normes d’audit",
