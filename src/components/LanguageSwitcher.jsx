  ...
  return (
    <div className="flex items-center gap-1.5">
      ...
      <select
        ...
        className="h-11 max-w-[7.5rem] cursor-pointer truncate rounded-[var(--radius-control)] border border-line bg-surface px-2 text-xs text-ink-soft outline-none transition hover:border-signal focus-visible:border-signal focus-visible:ring-2 focus-visible:ring-signal/30 sm:max-w-[9rem] sm:text-sm"
      >
